...
func (srv *endlessServer) ListenAndServe() (err error) { // {{{
	...
	srv.EndlessListener = newEndlessListener(l, srv, srv.ListenerLimit)
...
func (srv *endlessServer) ListenAndServeTLS(certFile, keyFile string) (err error) { // {{{
	...
	srv.tlsInnerListener = newEndlessListener(l, srv, srv.ListenerLimit)
...
func newEndlessListener(l net.Listener, srv *endlessServer, n int) (el *endlessListener) { // {{{
	el = &endlessListener{
		Listener: l,
		server:   srv,
	}
...
func (el *endlessListener) acquire() { el.sem <- struct{}{} }
func (el *endlessListener) release() { <-el.sem }
