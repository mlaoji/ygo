...
var file_service_proto_rawDesc = []byte{
	...
	0x0a, 0x79, 0x67, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x95, 0x01, 0x0a, 0x07,
	...
	0x1f, 0x2e, 0x79, 0x67, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x71,
	...
	0x02, 0x38, 0x01, 0x22, 0x23, 0x0a, 0x05, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x1a, 0x0a, 0x08,
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x3e, 0x0a, 0x0a, 0x59, 0x47, 0x4f, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30, 0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x13,
	0x2e, 0x79, 0x67, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x11, 0x2e, 0x79, 0x67, 0x6f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x2e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2e, 0x2f, 0x70,
...
var file_service_proto_goTypes = []interface{}{
	(*Request)(nil), // 0: ygoservice.Request
	(*Reply)(nil),   // 1: ygoservice.Reply
	nil,             // 2: ygoservice.Request.ParamsEntry
}
var file_service_proto_depIdxs = []int32{
	2, // 0: ygoservice.Request.params:type_name -> ygoservice.Request.ParamsEntry
	0, // 1: ygoservice.YGOService.Call:input_type -> ygoservice.Request
	1, // 2: ygoservice.YGOService.Call:output_type -> ygoservice.Reply
...
// YGOServiceClient is the client API for YGOService service.
//
...
func NewYGOServiceClient(cc grpc.ClientConnInterface) YGOServiceClient {
	return &yGOServiceClient{cc}
}

func (c *yGOServiceClient) Call(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/ygoservice.YGOService/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// YGOServiceServer is the server API for YGOService service.
type YGOServiceServer interface {
	Call(context.Context, *Request) (*Reply, error)
}

// UnimplementedYGOServiceServer can be embedded to have forward compatible implementations.
type UnimplementedYGOServiceServer struct {
}

func (*UnimplementedYGOServiceServer) Call(context.Context, *Request) (*Reply, error) {
